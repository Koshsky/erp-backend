...
WHERE t.deleted_at IS NULL
  AND (@scope_view::text = 'all' OR (@scope_view::text = 'parent' AND p.owner_id = @user_id::bigint) OR (@scope_view::text = 'ancestor' AND pr.owner_id = @user_id::bigint) OR (@scope_view::text = 'own' AND t.owner_id = @user_id::bigint))
